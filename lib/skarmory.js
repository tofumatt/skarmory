	...
	*/
	...
	this._fail = function(args, httpClient) {
		...
		if (args.onFailure) {
			...
			Ti.API.warn("Skarmory was used to make a Twitter API request, but the request failed and no onFailure callback was supplied. This will likely break your app.");
		}
	}
	...
	this._request = function(method, args, httpMethod) {
		...
		if (httpClient.status == 200) {
			if (args.onSuccess) {
				...
				Ti.API.warn("Skarmory was used to make a Twitter API request, but no onSuccess callback function was supplied. This will likely break your app.");
			}
		} else {
